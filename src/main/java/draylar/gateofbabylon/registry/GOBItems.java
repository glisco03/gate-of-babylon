...
public class GOBItems {
    ...
    public static final BroadswordItem STONE_BROADSWORD = register("stone_broadsword", new BroadswordItem(ToolMaterials.STONE, 7f, 1.0f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1)));
    public static final BroadswordItem IRON_BROADSWORD = register("iron_broadsword", new BroadswordItem(ToolMaterials.IRON, 8f, 1.0f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1)));
    public static final BroadswordItem GOLDEN_BROADSWORD = register("golden_broadsword", new BroadswordItem(ToolMaterials.GOLD, 5f, 1.0f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1)));
    public static final BroadswordItem DIAMOND_BROADSWORD = register("diamond_broadsword", new BroadswordItem(ToolMaterials.DIAMOND, 9f, 1.0f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1)));
    public static final BroadswordItem NETHERITE_BROADSWORD = register("netherite_broadsword", new BroadswordItem(ToolMaterials.NETHERITE, 11f, 1.0f, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).fireproof()));
    ...
    public static final CustomBowItem GOLDEN_BOW = register("golden_bow", new CustomBowItem(ToolMaterials.GOLD, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(150), 10.0F, 1.0, new ColoredCritParticleEffect(new Vec3f(Vec3d.unpackRgb(0xfecd03)))));
    public static final CustomBowItem DIAMOND_BOW = register("diamond_bow", new CustomBowItem(ToolMaterials.DIAMOND, new Item.Settings().group(GateOfBabylon.GROUP).maxCount(1).maxDamage(1561), 20.0F, 1.25, new ColoredCritParticleEffect(new Vec3f(Vec3d.unpackRgb(0x34ebc9)))));
